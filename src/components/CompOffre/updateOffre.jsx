...
class updateOffre extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        OffreService.getOffreById(this.state.id).then((res) => {
            ...
            this.setState({
                ...
                nombre_Poste: this.state.nombre_Poste,
                type: this.state.type,
                adresse: this.state.adresse, salaire: this.state.salaire,
                niveau: this.state.niveau, genre: this.state.genre,
                langue: this.state.langue,
                experience: this.state.experience,
                categorie: this.state.categorie,
                motCles: this.state.motCles,
    ...
    updateOffre = (e) => {
        ...
        OffreService.updateOffre(offre).then(res => {
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='card col-md-6 offset-md-3 offset-md-3'>
                            <h1 className="text-center">Add Offre</h1>
                            <div className='card-body'>
                                <Form
                                    onSubmit={this.updateOffre}
                                    ref={(c) => {
                                        this.form = c;
                                    }}
                                >
                                    <div className='form-group'>
                                        <label>ID:</label>
                                        <Input placeholder='ID' name='ID' className='form-control' value={this.state.Id_offre} onChange={this.changeIdHandler} />
                                    </div>
                                    <div className='form-group'>
                                        <label>Titre:</label>
