...
class ListeCandidature extends Component {
    constructor(props) {
        ...
        this.envoyerEntretien = this.envoyerEntretien.bind(this);
    }
    ...
    envoyerEntretien(id) {
        this.props.history.push(`/envoyerEntretien/${id}`);
    }
                                    ...
                                    Candidature =>
                                        <tr key={Candidature.id}>
                                            ...
                                            <td>
                                                ...
                                                <button style={{ marginLeft: "10px" }}
                                                    onClick={() => this.envoyerEntretien(Candidature.id)}
                                                    className="btn btn-info">envoyerEntretien</button>
                                            </td>
                                        </tr>
                                )
                            }
